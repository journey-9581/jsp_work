	...
	<div class="container">
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<a href="${pageContext.request.contextPath }/gallery/list.jsp" class="btn btn-outline-secondary">목록</a>
				...
				<div>
					<%if(dto.getPrevNum()!=0) { %>
						<a href="${pageContext.request.contextPath }/gallery/detail.jsp?num=<%=dto.getPrevNum()%>" class="btn btn-outline-primary">이전</a>
					<%} %>
					<%if(dto.getNextNum()!=0) { %>
						<a href="${pageContext.request.contextPath }/gallery/detail.jsp?num=<%=dto.getNextNum()%>" class="btn btn-outline-primary">다음</a>
					<%} %>
				</div>
			</div>
		</div>	
